 ...
 */
@Entity
@Table(uniqueConstraints = { @UniqueConstraint(columnNames = { "referenceCode" }) })
@XmlRootElement
...
public class Transactions implements Serializable {
	...
	public Transactions(String referenceCode, String description, double amount, double tax, int taxReturnBase,
			String currency, String buyerFullName, String buyerEmail, String test, String payHash, Date created) {
		this.referenceCode = referenceCode;
	...
	public boolean equals(Object object) {
		...
		if ((this.referenceCode == null && other.referenceCode != null)
				|| (this.referenceCode != null && !this.referenceCode.equals(other.referenceCode))) {
			return false;
		}
		return true;
	}
